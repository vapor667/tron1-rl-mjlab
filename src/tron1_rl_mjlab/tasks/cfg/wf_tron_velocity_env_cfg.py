...
from .terrain_cfg import PLANE_ENTITY_CFG
from .. import mdp
...
def make_rewards() -> dict[str, RewardTermCfg]:
	...
	return {
		...
		"joint_torque_l2": RewardTermCfg(func=mdp.joint_torques_l2, weight=-1.6e-4),
		...
		"action_smoothness": RewardTermCfg(func=mdp.action_smoothness_penalty, weight=-0.03),
